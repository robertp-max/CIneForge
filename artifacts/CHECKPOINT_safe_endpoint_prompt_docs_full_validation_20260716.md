# Checkpoint: safe endpoint prompt docs full validation

Date: 2026-07-16

## Validation

After committing safe endpoint docs guards for `/local-runtime/checkpoint-watchdog` and `/api/prompt`, ran:
