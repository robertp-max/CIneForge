 ...
 *
 * Catalog template list: A New Journey Phase A names (mockProject.workflows structure).
 * Installed / Ready flags are honest defaults (not verified against ComfyUI) unless a
 * future inventory API reports otherwise. Install remains unavailable (no install API).
 * Validate is a local simulation only — it does not prove node/model presence.
 */
...
const RUNTIME_NOTE =
  'ComfyUI inventory not verified on this surface · planning templates only · CineForge does not start ComfyUI'
