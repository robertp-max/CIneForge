    ...
    prompt_packages: [
      {
        ...
        provider_profile_id: 'flux2-dev-fp8mixed',
        provider_model_id: 'Flux2 Dev FP8 Mixed',
        proposal_id: null,
...
export const demoPhaseASnapshot: PhaseASnapshot = {
  ...
  readiness: {
    ...
    reasons: [
      ...
      { code: 'model_gap', message: 'Acknowledge the required LTX 2.3 22B Distilled 1.1 FP8 checkpoint.', entity_id: null, blocking: true },
