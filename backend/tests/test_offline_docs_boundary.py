...
CURRENT_VALIDATION_RESULT = "213 passed"
STALE_VALIDATION_WARNING_RESULT_RE = r"(?:15[0-9]|16[0-9]|17[0-9]|18[0-9]|19[0-9]|20[0-9]|21[0-2]) passed(?:, \d+ warnings)?|213 passed, \d+ warnings"
