...
CURRENT_VALIDATION_RESULT = "235 passed"
STALE_VALIDATION_WARNING_RESULT_RE = r"(?:15[0-9]|16[0-9]|17[0-9]|18[0-9]|19[0-9]|20[0-9]|21[0-9]|22[0-9]|23[0-4]) passed(?:, \d+ warnings)?|235 passed, \d+ warnings"
