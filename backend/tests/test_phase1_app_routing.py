...
REVIEWED_ROUTERS = (
    ...
    ("jobs", jobs.router),
    ("local_archetypes", local_archetypes.router),
    ("local_generation", local_generation.router),
    ("local_jobs", local_jobs.router),
    ("local_post_production", local_post_production.router),
    ("local_presets", local_presets.router),
    ("local_runtime", local_runtime.router),
...
REQUIRED_METHOD_PATHS = {
    ...
    ("POST", "/local-generation/semantic-requests"),
    ("GET", "/local-generation/semantic-requests"),
