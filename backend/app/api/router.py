...
api_router.include_router(local_generation.operator_router)
...
api_router.include_router(local_post_production.operator_router)
api_router.include_router(local_presets.router)
api_router.include_router(local_runtime.router)
api_router.include_router(local_runtime.operator_router)
