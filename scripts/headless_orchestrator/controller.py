...
class HeadlessController:
    def __init__(self, state_root: Path, max_grok_workers: int = 64):
        if not 1 <= max_grok_workers <= 64:
            raise ValueError("max_grok_workers must reserve a separate 65th Sol review slot")
